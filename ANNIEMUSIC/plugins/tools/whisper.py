    ...
    if len(data.split()) < 2:
        mm = [
            InlineQueryResultArticle(
                ...
                thumb_url="https://graph.org/file/dd77a888a78c123e1ae10.jpg",
...
async def in_help():
    answers = [
        InlineQueryResultArticle(
            title="⦿ Whisper ⦿",
            description=f"@Eva_Ro_bot [USERNAME | ID] [TEXT]",
            input_message_content=InputTextMessageContent(f"**❍ Usage:**\n\n@Eva_Ro_bot (Target Username or ID) (Your Message).\n\n**Example:**\n@Eva_Ro_bot @username I Wanna Phuck You"),
            thumb_url="https://telegra.ph/file/2c6d1a6f78eba6199933a.jpg",
            reply_markup=switch_btn
        )
    ]
